...
const getAutomatedData = (): Activity[] => {
    const context = require.context('../two_partial', false, /\.(js|jsx|ts|tsx)$/);
    ...
    return (
        <View style={styles.container}>
            <SectionList
                ...
                ListHeaderComponent={<Text style={styles.mainTitle}>Segundo Parcial</Text>}
